...
/**
 * Renders the ordered career history as a flat table with a languages column.
 *
...
function title(commit: CareerCommit): string {
  const after = commit.title.split('·')[1]
  return (after ?? commit.title).trim()
}
